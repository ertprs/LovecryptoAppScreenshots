...
import { Button, Divider, Layout, useTheme, Text } from '@ui-kitten/components';
...
export const TermsScreen = ( props ) => {
  ...
  return (
    <SafeAreaView
      ...
      <TopNavigationHeader navigation = {props.navigation}  title = 'Termos e condições'/>
          <ScrollView>   
          <SectionBanner type = 'terms'/>
            <Layout style={{justifyContent: 'center', alignItems: 'center', padding: 32,}}>
              <Text style = {generalStyle.paragraph}>
              Estes termos e condições ("Termos", "Contrato") são um contrato entre o Mobile Application Developer ("Mobile Application Developer", "nos", "nós" ou "nosso") e você ("Usuário", "você" ou "seu"). Este Contrato estabelece os termos e condições gerais de uso do aplicativo móvel Lovecrypto e qualquer um de seus produtos ou serviços (coletivamente, "Aplicativo Móvel" ou "Serviços").
            </Text>
