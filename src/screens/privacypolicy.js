      ...
      <TopNavigationHeader navigation = {props.navigation}  title = 'Politica de privacidade'/>
        <ScrollView>   
          ...
          <Layout style={{justifyContent: 'center', alignItems: 'center', padding: 32,}}>
            ...
            <Text style = {generalStyle.paragraph}>
              Os termos usados ​​nesta Política de Privacidade têm os mesmos significados que em nossos Termos e Condições, acessíveis na Lovecrypto, a menos que definido de outra forma nesta Política de Privacidade.
            </Text>
